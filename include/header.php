            ...
            <div class="nav-bar px-0 py-lg-0" style="height: 80px;">
                <nav class="navbar navbar-expand-lg navbar-light d-flex justify-content-lg-end">
                    <a href="#" class="navbar-brand-2">
                        <img class="mob-logo" src="img/logo.png" alt="Logo">
                    </a>
                        ...
                        <div class="navbar-nav mx-0 mx-lg-auto ">
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link" data-bs-toggle="dropdown">
                                    <span class="dropdown-toggle">Academics</span>
                                </a>
                                <div class="dropdown-menu">
                                    <a href="project.php" class="dropdown-item">Programs</a>
                                    <a href="team.php" class="dropdown-item">Curriculum</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link" data-bs-toggle="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="" class="dropdown-item">Admission News</a>
                                    <a href="" class="dropdown-item">How To Apply</a>
                                </div>
                            </div>
